...
📌 What this shows:  
Evaluation of model performance including True Positives, False Positives, True Negatives, and False Negatives.

![Confusion Matrix](images/confusion_matrix.png)

### 📈 ROC Curve
📌 What this shows:  
Model performance across different classification thresholds using ROC-AUC score.

![ROC Curve](images/roc_curve.png)

### 🧠 SHAP Explanation
📌 What this shows:  
Explains how each feature impacts the model’s prediction for fraud detection.
